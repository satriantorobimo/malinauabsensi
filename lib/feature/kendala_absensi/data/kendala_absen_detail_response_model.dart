class KendalaAbsenDetailResponseModel {
  String? status;
  String? message;
  Data? data;

  KendalaAbsenDetailResponseModel({this.status, this.message, this.data});

  KendalaAbsenDetailResponseModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
