...
class KendalaAbsenScreen extends StatefulWidget {
  const KendalaAbsenScreen({super.key});

  @override
  State<KendalaAbsenScreen> createState() => _KendalaAbsenScreenState();
}

class _KendalaAbsenScreenState extends State<KendalaAbsenScreen> {
  ListBloc listBloc = ListBloc(kendalaAbsenRepo: KendalaAbsenRepo());
  List<Data> data = [];
  List<Data> tempData = [];
  ...
  @override
  void initState() {
    listBloc.add(const KendalaListAttempt(start: '', end: ''));
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.pushNamed(
                                      context,
                                      StringRouterUtil
                                          .buatKendalaAbsenScreenRoute)
                                  .then(
                                (value) {
                                  listBloc.add(const KendalaListAttempt(
                                      start: '', end: ''));
                                },
                              );
                            },
            ...
            //                       listBloc.add(KendalaListAttempt(
            ...
            BlocListener(
                ...
                listener: (_, ListState state) async {
                  ...
                  if (state is ListLoaded) {
                    setState(() {
                      data = state.kendalaAbsenListResponseModel.data!;
                      tempData = data;
                    });
                  }
      ...
      child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            return InkWell(
              onTap: () {
                Navigator.pushNamed(
                    context, StringRouterUtil.kendalaAbsenDetailScreenRoute,
