...
import 'package:malinau_absensi/feature/aktifitas/bloc/dinas_luar_list_bloc/bloc.dart';
...
class DinasLuarScreen extends StatefulWidget {
  ...
  @override
  State<DinasLuarScreen> createState() => _DinasLuarScreenState();
}

class _DinasLuarScreenState extends State<DinasLuarScreen> {
  List<String> filter = [
    'Semua',
    '7 hari terakhir',
    'Bulan ini',
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          return InkWell(
            onTap: () {
              Navigator.pushNamed(
                  context, StringRouterUtil.dinasLuarDetailScreenRoute,
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    height: 60,
                    decoration: BoxDecoration(
                      color: dataList[index].statusPengajuan == 'Pending'
                          ? yellowColor
                          : greenColor,
