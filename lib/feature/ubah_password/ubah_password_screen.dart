...
import 'package:malinau_absensi/feature/ubah_password/bloc/ubah_password_bloc/bloc.dart';
...
class _UbahPasswordScreenState extends State<UbahPasswordScreen> {
  ...
  UbahPasswordBloc ubahPasswordBloc =
      UbahPasswordBloc(ubahPasswordRepoRepo: UbahPasswordRepoRepo());
  final TextEditingController _passwordKonfBaruCtrl = TextEditingController();
  final TextEditingController _passwordBaruCtrl = TextEditingController();
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                              ...
                              Material(
                                shape: RoundedRectangleBorder(
                                    ...
                                    side: const BorderSide(
                                        width: 1.0, color: Color(0xFF9E9E9E))),
                                child: TextFormField(
                                  controller: _passwordKonfBaruCtrl,
                                  keyboardType: TextInputType.text,
                                  obscureText: showPassword2,
                                  decoration: InputDecoration(
                                      hintText:
                      ...
                      const SizedBox(height: 24),
                      BlocListener(
                          bloc: ubahPasswordBloc,
                          listener: (_, UbahPasswordState state) async {
                            if (state is UbahPasswordLoading) {
                              setState(() {
                                isLoading = true;
                              });
                            }
                            if (state is UbahPasswordLoaded) {
                              setState(() {
                                GeneralUtil().showSnackBarSuccess(context,
                                    state.ubahPasswordResponseModel.message!);
                                Future.delayed(
                            ...
                            if (state is UbahPasswordException) {
                              setState(() {
                                isLoading = false;
                              });
                              GeneralUtil()
                          ...
                          child: BlocBuilder(
                              bloc: ubahPasswordBloc,
                              builder: (_, UbahPasswordState state) {
                                return isLoading
                                    ? const Center(
                                        child: SizedBox(
                                          width: 45,
                                    ...
                                    : InkWell(
                                        onTap: () {
                                          if (_passwordKonfBaruCtrl
                                                  .text.isEmpty ||
                                              _passwordKonfBaruCtrl.text ==
                                                  '' ||
                                              _passwordCtrl.text.isEmpty ||
                                              _passwordCtrl.text == '' ||
                                              _passwordBaruCtrl.text.isEmpty ||
                                              _passwordBaruCtrl.text == '') {
                                            GeneralUtil().showSnackBarError(
                                                context,
                                                'Password tidak boleh kosong');
                                          } else if (_passwordBaruCtrl.text !=
                                              _passwordKonfBaruCtrl.text) {
                                            GeneralUtil().showSnackBarError(
                                                context,
                                                'Password baru tidak sama');
                                          } else {
                                            ubahPasswordBloc.add(
                                                UbahPasswordAttempt(
                                                    ubahPasswordRequestModel:
                                                        UbahPasswordRequestModel(
                                                            password:
                                                                _passwordCtrl
                                                                    .text,
